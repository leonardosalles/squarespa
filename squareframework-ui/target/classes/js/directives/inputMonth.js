define(['square/directives/directives'], function (directives) {
	...
	directives.directive('squareInputMonth', function ($filter) {
		...
		return {
			...
			link: function (scope, element, attr, ctrl) {
				...
				ctrl.$parsers.unshift(function (value) {
					if (!value) {
						element.removeAttr('data-square-validate-month');
						...
						if (angular.isDate(date)) {
							...
							element.attr('data-square-validate-month', scope.$eval(attr.squareInputMonthMessage) || I18n.t('square.validation.type.date', {pattern: 'MM/yyyy'}));

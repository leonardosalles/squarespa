define(['square/directives/directives'], function (directives) {
	...
	directives.directive('squareInputCnpj', function () {
		...
		return {
			...
			link: function (scope, element, attr, ctrl) {
				var opts = angular.extend({mask: '99.999.999/9999-99', autoTab: false}, scope.$eval(attr.squareInputCnpj));
				...
				ctrl.$formatters.push(function (value) {
					...
					if (validated) {
						element.removeAttr('data-square-validate-cnpj');
					} else {
						element.attr('data-square-validate-cnpj', scope.$eval(attr.squareInputCnpjMessage) || I18n.t('square.validation.type.cnpj'));
					}
				...
				ctrl.$parsers.push(function (value) {
					if (!value || validator(value)) {
						...
						element.attr('data-square-validate-cnpj', scope.$eval(attr.squareInputCpfMessage) || I18n.t('square.validation.type.cnpj'));

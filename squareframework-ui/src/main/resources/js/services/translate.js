define(['square/services/services',
        'square/services/translate-locale_en',
        'square/services/translate-locale_pt-br'], function (services, localeEn, localePtBr) {
	'use strict';
	...
	services.provider('$translate', function ($provide) {
		...
		this.configure = function () {
			var lookupDate = I18n.lookup('square.date');
			...
			$.extend($.fn.select2.defaults, {
				formatNoMatches: function () { return I18n.t('square.select2.formatNoMatches'); },
				formatInputTooShort: function (input, min) { var n = min - input.length; return I18n.t('square.select2.formatInputTooShort', {count: n}); },
				formatInputTooLong: function (input, max) { var n = input.length - max; return I18n.t('square.select2.formatInputTooLong', {count: n}); },
				formatSelectionTooBig: function (limit) { return I18n.t('square.select2.formatSelectionTooBig', {count: limit}); },
				formatLoadMore: function () { return I18n.t('square.select2.formatLoadMore'); },
				formatSearching: function () { return I18n.t('square.select2.formatSearching'); }
			});
			...
			$provide.value('$locale', {
				...
				'NUMBER_FORMATS': {
					'CURRENCY_SYM': I18n.lookup('square.number').currency_sym + ' ',
					'DECIMAL_SEP': I18n.lookup('square.number').decimal_sep,
					'GROUP_SEP': I18n.lookup('square.number').group_sep,
	...
	services.config(function ($translateProvider) {
		...
		$translateProvider.translations('en', {square: localeEn});
		$translateProvider.translations('pt-BR', {square: localePtBr});
